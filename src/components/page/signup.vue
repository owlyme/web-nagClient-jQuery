        ...
        <el-col class="signbox" :span="20" :xs="24" :sm="20" :md="20" :lg="20" :xl="20" :offset="2">
            <el-row :gutter="0">
                    ...
                    <el-container>
                        ...
                        <el-main>
                            ...
                            >
                                ...
                                >
                                    <el-step :title="$t('message.create_account')"></el-step>
                ...
                >
                        ...
                        <el-main>
                            <el-form>
                                ...
                                <el-form-item style="text-align: left">
                                    <el-checkbox v-model="ischecked">{{$t('signup.hint2')}}</el-checkbox>
                                </el-form-item>
                                <el-form-item>
                                    <el-button
                                        style="width:100%"
                                        type="primary"
                                        @click="register"
                                    >{{$t('replenished.establish')}}</el-button>
                                </el-form-item>
                            </el-form>
                        </el-main>
                    </div>
                    <div class="paddingbox" v-show="active == 1">
                        ...
                        <el-main>
                            ...
                            <el-row v-show="cnEtc" class="tb-margin" :gutter="10">
                                ...
                                <el-col :span="8" class="positionrelative center">
                    ...
                    <div class="paddingbox" v-show="active == 3">
                        <el-header class="flex flexcolumn title">
                    ...
                    <div class="paddingbox" v-show="active == 4 || active == 5">
...
export default {
    data() {
        return {
            rules: {
                lastNameEN: [{ required: true, message: this.$t('message.Pleaseinput') + this.$t('signup.enlastname'), trigger: 'blur' }]
                //   region: [
    ...
    created() {
        if (this.active != 0) {
            this.$api.user.userinfo({}, res => {
                ...
                if (localStorage[res.data.info.id] != undefined) {
                    this.alldata = JSON.parse(localStorage[res.data.info.id]).alldata;
                    this.okdatadatum = JSON.parse(localStorage[res.data.info.id]).okdatadatum;
                }
            });
        }
    ...
    methods: {
        ...
        go(e, dataall) {
            if (e == 1) {
                this.$api.user.userinfo(this.alldata, e => {});
            }
            if (e == 2) {
            ...
            if (e == 3) {
                //         this.$refs[dataall].validate((valid) => {
                //   if (valid) {
                if (
                ...
                this.$api.user.userfillIdentity(this.alldata, res => {
                    if (res.code == 406) {
                        this.$confirm(this.$t('signup.hint8'), this.$t('hint.hint'), {
                            ...
                            cancelButtonText: this.$t('message.return'),
                            type: 'warning'
                        })
                            .then(() => {
