                    ...
                    <el-form :inline="true" class="demo-form-inline form-inline-container">
                        <el-form-item label="關鍵詞">
                            <el-input
                                v-model="screen.key"
                                style="width:180px"
                                placeholder="用戶名/電話/郵箱"
                            ></el-input>
                        </el-form-item>

                        <el-form-item :label="$t('message.marketleve')">
                            <el-select
                                v-model="screen.rating"
                    ...
                    <div class="table-container">
                        ...
                        >
                            ...
                            <el-table-column
                                align="left"
                                prop="phone"
                                :label="$t('message.cellphonenumber')"
                            ></el-table-column>
                            ...
                            <el-table-column
                                align="left"
                                prop="createTime"
                                :label="$t('Toactivate.hint7')"
                            ></el-table-column>
                            <el-table-column
                                align="left"
                                prop="inviteTime"
                                :label="$t('Toactivate.hint8')"
                            ></el-table-column>
                                ...
                                <template slot-scope="scope">
                                    ...
                                    <div class="flex">
                                        <el-button-group>
                                            ...
                                            <el-tooltip
                                                :content="$t('Toactivate.hint10')"
                                                placement="top"
                                            >
                                                <el-button
                                                    type="primary"
                                                    icon="iconfont icon-genjin"
                                                    @click="showdetails(scope.row.id)"
                                                ></el-button>
                                            </el-tooltip>
                                            <el-tooltip
                                                v-if="!scope.row.registered"
                                                :content="$t('message.change')"
                                                placement="top"
                                            >
                                                <el-button
                                            ...
                                            <el-popover
                                                placement="right"
                                                trigger="click"
                                                v-if="!scope.row.registered && scope.row.showCopy"
